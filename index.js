function carregar(){
    ...
    if (hora >= 0 && hora <5){
        img.src= '/Circulo-horario/fotomadruga.png'
        msg2.innerHTML = "Boa Madrugada para você"
        document.body.style.backgroundImage = "url('/Fundo-horario/madrugada.jpg')"
        ...
        img.src = '/Circulo-horario/fotomanha.png'
        msg2.innerHTML = "Bom Dia para você"
        document.body.style.backgroundImage = "url('/Fundo-horario/fundo.jpg')"
        espaço.style.backgroundColor = ("#00b0c150")
    } else if 
        (hora >12 && hora <=18){
        img.src = '/Circulo-horario/fototarde.png'
        msg2.innerHTML = "Boa Tarde para você"
        document.body.style.backgroundImage = "url('/Fundo-horario/tarde.jpg')"
        espaço.style.backgroundColor = ("#971b0750")
    } else{
        img.src = '/Circulo-horario/fotonoite.png'
        msg2.innerHTML = "Boa Noite para Você"
        document.body.style.backgroundImage = "url('/Fundo-horario/noite.jpg')"
